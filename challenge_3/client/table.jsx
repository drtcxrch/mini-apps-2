...
const Table = (props) => {
  ...
  return (
    <table id='scorecardTable' className='scorecard' cellPadding='1' cellSpacing='0'>
      ...
      <tr>
        <td colSpan='3'></td><td id="frame1" colSpan='3'>{score.frame_1 ? score.frame_1.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame2" colSpan='3'>{score.frame_2 ? score.frame_2.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame3" colSpan='3'>{score.frame_3 ? score.frame_3.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame4" colSpan='3'>{score.frame_4 ? score.frame_4.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame5" colSpan='3'>{score.frame_5 ? score.frame_5.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame6" colSpan='3'>{score.frame_6 ? score.frame_6.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame7" colSpan='3'>{score.frame_7 ? score.frame_7.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame8" colSpan='3'>{score.frame_8 ? score.frame_8.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame9" colSpan='3'>{score.frame_9 ? score.frame_9.roll_2 : null}</td>
          <td colSpan='3'></td><td id="frame10" colSpan='3'>{score.frame_10 ? score.frame_10.roll_2 : null}</td>
      </tr>
      <tr>
        <td colSpan='6' id="marker0">{score.frame_1 ? score.frame_1.roll_1 : null}</td>
